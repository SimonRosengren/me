<template>
    <div class="h-screen font-display bg-transparent relative">
        ...
        <section id="me">
            <FullscreenParagraph class=" bg-[url('public/img/cover1.png')] sm:bg-center bg-fixed bg-[length:250%_100vh] sm:bg-cover bg-no-repeat" divide>
                <template #header-lg>
